...
*/
@Configuration
@MapperScan(value = "com.example.demo.dao")//,sqlSessionTemplateRef = "sqlSessionTemplatePrimary"
public class MybatisConfig {
    ...
    public DynamicDataSource dataSource(@Qualifier("primaryDataSource") DataSource primaryDataSource,
        ...
        targetDataSources.put(DatabaseType.primaryDataSource, primaryDataSource);
        targetDataSources.put(DatabaseType.readonlyDataSource, readonlyDataSource);
